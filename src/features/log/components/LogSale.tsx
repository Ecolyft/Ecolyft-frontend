                ...
                <div className="space-y-3">
                    ...
                    {lines.map(line => (
                        <div key={line.id} className="flex items-center gap-3">
                            ...
                            <div className="flex-1 bg-slate-50 border border-slate-100 px-4 py-3 rounded-lg text-sm text-slate-600">
                            ...
                            <div className="flex-1">
                                <input
                                    ...
                                    placeholder="0 kg"
                                    className="w-full px-4 py-3 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-blue/20"
                                />
                            </div>
                            <button
                                type="button"
